  ...
  <div className="rounded-xl group relative shadow-card hover:shadow-cardhover card">
    ...
    <div className="group-hover:flex flex-col max-h-[94.5%] hidden absolute bottom-0 left-0 right-0 bg-[#10131f] m-2 p-2 rounded-md bg-opacity-50 backdrop-filter backdrop-blur-xl">
      ...
      <div className="mt-5 flex justify-between items-center gap-2">
        ...
        <button type="button" onClick={() => downloadImage(_id, photo)} className="outline-none bg-transparent border-none flex flex-row text-white">
          download <img src={download} alt="download" className="w-6 h-6 object-contain invert" />
        </button>
      </div>
    </div>
  </div>
