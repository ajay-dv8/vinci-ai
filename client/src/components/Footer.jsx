          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-600 dark:text-gray-400">
                      <li class="mb-4">
                          <a href="https://github.com/ajay-dv8/" class="hover:underline ">Github</a>
                      </li>
                      {/*
                      <li>
          ...
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            {/*
              ...
              */}
              ...
              <a href="https://github.com/ajay-dv8/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
